...
const service1 = '/assets/services/service-1.png'; // service1.svg 이미지
const service2 = '/assets/services/service-2.png'; // service2.svg 이미지
const service3 = '/assets/services/service-3.png'; // service3.svg 이미지
                            ...
                            <div className='py-12 px-4 xl:px-8'>
                                ...
                                <ul className='flex items-center justify-between'>
                                    {brainwaveServicesIcons.map(
                                        (item, index) => {
                                            const BrainwaveIcon = item; // 전달된 아이콘울 컴포넌트로 만듬
                                            return (
                                                <li
                                                    key={index}
